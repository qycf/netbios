...
namespace ImTricks {
    ...
    namespace Animations {
        ...
        int FastIntLerp(const char* identifier, bool state, int min, int max, int speed) {
            static std::unordered_map<const char*, int>* pValuesMapInt = nullptr;
            if (pValuesMapInt == nullptr) {
                pValuesMapInt = new std::unordered_map<const char*, int>();
            }
            std::unordered_map<const char*, int>& valuesMapInt = *pValuesMapInt;
        ...
        float FastFloatLerp(std::string identifier, bool state, float min, float max, float speed) {
            static std::unordered_map<std::string, float>* pValuesMapFloat = nullptr;
            if (pValuesMapFloat == nullptr) {
                pValuesMapFloat = new std::unordered_map<std::string, float>();
            }
            std::unordered_map<std::string, float>& valuesMapFloat = *pValuesMapFloat;
        ...
        ImVec2 FastImVec2Lerp(const char* identifier, bool state, ImVec2 min, ImVec2 max, float speed) {
            static std::unordered_map<const char*, ImVec2>* pValuesMapImVec2 = nullptr;
            if (pValuesMapImVec2 == nullptr) {
                pValuesMapImVec2 = new std::unordered_map<const char*, ImVec2>();
            }
            std::unordered_map<const char*, ImVec2>& valuesMapImVec2 = *pValuesMapImVec2;
            auto value = valuesMapImVec2.find(identifier);

            if (value == valuesMapImVec2.end()) {
                valuesMapImVec2.insert({ identifier, min });
                value = valuesMapImVec2.find(identifier);
            }
