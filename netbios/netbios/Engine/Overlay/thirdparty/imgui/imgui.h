...
enum ImGuiCol_
{
    ...
    ImGuiCol_NavWindowingBg,
    ImGuiCol_ModalWindowDimBg,      // Darken/colorize entire screen behind a modal window, when one is active
    ImGuiCol_CheckboxBg,
    ImGuiCol_CheckboxCircle,
    ImGuiCol_CheckboxBgActive,
    ImGuiCol_CheckboxCircleActive,
    ImGuiCol_COUNT
};
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddCircle(const ImVec2& center, float radius, ImU32 col, int num_segments = 360, float thickness = 1.0f);
    IMGUI_API void  AddCircleFilled(const ImVec2& center, float radius, ImU32 col, int num_segments = 360);
